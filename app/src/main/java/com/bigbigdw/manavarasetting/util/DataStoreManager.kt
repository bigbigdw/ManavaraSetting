...
class DataStoreManager(private val context: Context) {
    ...
    companion object {
        ...
        val STATUS_NAVER_CHALLENGE_NOVEL_FANTAGY = stringPreferencesKey("STATUS_NAVER_CHALLENGE_NOVEL_FANTAGY")
        val STATUS_NAVER_CHALLENGE_NOVEL_MARTIAL_ARTS = stringPreferencesKey("STATUS_NAVER_CHALLENGE_NOVEL_MARTIAL_ARTS")
        val STATUS_NAVER_CHALLENGE_NOVEL_MODERN_FANTAGY = stringPreferencesKey("STATUS_NAVER_CHALLENGE_NOVEL_MODERN_FANTAGY")
        val STATUS_NAVER_CHALLENGE_NOVEL_MYSTERY = stringPreferencesKey("STATUS_NAVER_CHALLENGE_NOVEL_MYSTERY")
        val STATUS_NAVER_CHALLENGE_NOVEL_ROMANCE = stringPreferencesKey("STATUS_NAVER_CHALLENGE_NOVEL_ROMANCE")
        val STATUS_NAVER_CHALLENGE_NOVEL_ROMANCE_FANTAGY = stringPreferencesKey("STATUS_NAVER_CHALLENGE_NOVEL_ROMANCE_FANTAGY")
    }
