...
interface ApiMoonPia {
    ...
    fun postMoonPiaBest(@FieldMap queryMap: MutableMap<String?, Any>): Call<BestMunpiaResult>
    ...
    fun postMoonPiaBestPay(@FieldMap queryMap: MutableMap<String?, Any>): Call<BestMunpiaResult>
